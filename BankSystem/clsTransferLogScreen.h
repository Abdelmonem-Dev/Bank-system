...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClient::sTransferLog TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsBankClient::sTransferLog> vTransferLogRecord = clsBankClient::GetTransferLogList();
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (clsBankClient::sTransferLog Record : vTransferLogRecord)
            {
